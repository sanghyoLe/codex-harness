...
- [ ] Agent template(s)
- [ ] Plugin manifest (`plugins/harness/.codex-plugin/plugin.json`, marketplace metadata)
...
- [ ] `python3 plugins/harness/skills/harness/scripts/scaffold_harness.py --spec examples/code-reviewer/spec.json --target /tmp/codex-harness-demo` passes
