...
Implement API routes, data access, authentication, authorization, and business rules according to the agreed contracts.
...
- Auth, permissions, and operational safety
