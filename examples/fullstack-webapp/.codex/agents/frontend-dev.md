...
Implement pages, UI components, client-side state, and API integration according to the agreed architecture.
...
- Component composition and user flows
- API integration and resilient client state
...
- Report final findings to `qa-engineer`.
