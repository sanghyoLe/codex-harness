...
Define system shape, data boundaries, API contracts, and execution order so implementation roles can proceed with minimal ambiguity.
...
- Functional scope and system decomposition
- API boundaries and database modeling
- Change sequencing and implementation risk
...
- Write the output to `_workspace/01_architecture.md`.
