...
Validate interface coherence, test strategy, regression risk, and readiness for release.
...
- Critical user-flow coverage and regression risk
- Readiness gates for release or handoff
...
- Write the output to `_workspace/06_review_report.md`.
...
- Read inputs from `_workspace/01_architecture.md`, `_workspace/02_api_spec.md`, `_workspace/03_db_schema.md`, `src/` when relevant.
