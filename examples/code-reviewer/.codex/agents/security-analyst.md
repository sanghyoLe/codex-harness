...
Inspect trust boundaries, exploitable issues, unsafe defaults, and sensitive-data handling.
...
- Injection, unsafe deserialization, and sensitive-data exposure
- Security assumptions hidden in config or error handling
...
- Write the output to `_workspace/02_security_review.md`.
