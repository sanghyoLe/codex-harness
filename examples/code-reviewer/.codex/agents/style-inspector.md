...
Inspect naming, formatting, readability, comment quality, and local coding conventions.
...
- Naming consistency and local conventions
- Formatting and readability regressions
- Comment quality and misleading abstractions
...
- Write the output to `_workspace/01_style_review.md`.
